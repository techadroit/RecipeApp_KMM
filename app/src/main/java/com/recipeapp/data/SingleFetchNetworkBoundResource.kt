...
// */
//abstract class SingleFetchNetworkBoundResource<T : Any, U : Any, V : Any> :
...
//        return flow {
//            val cachedData =
//                getFromDatabase(isRefreshed = hasDataBeenFetched, limit = limit, offset = offset)
//
...
//                        val refreshedData =
//                            getFromDatabase(isRefreshed = true, limit = limit, offset = offset)!!
...
//    crossinline dataPersister: suspend (U) -> Unit
//): Flow<Resource<T>> {
//    return singleFetchNetworkBoundResource(
//        initialParams,
//        dbFetcher,
//        apiFetcher,
//        cacheValidator,
